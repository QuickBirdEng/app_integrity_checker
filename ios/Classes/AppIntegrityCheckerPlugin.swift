...
public func getHash86() -> String{
    ...
    public func checkCodeSignature() -> Array<String> {
        guard let url = Bundle.main.url(forResource: "CodeResources", withExtension:nil,subdirectory: "_CodeSignature") else{ return [String]() }
